package com.zayd.assistant.core.orchestrator

import com.zayd.assistant.audio.VoiceActivityDetector
import com.zayd.assistant.audio.WakeWordDetector
import com.zayd.assistant.audio.WakeWordResult
import com.zayd.assistant.llm.ConversationMessage
import com.zayd.assistant.llm.LLMProvider
import com.zayd.assistant.llm.LLMResponse
import com.zayd.assistant.llm.MessageRole
...
import com.zayd.assistant.toolbox.ToolCall
...
class AssistantOrchestratorTest {
    ...
    fun `test wake word detection flow`() = runTest {
        ...
        coEvery { mockWakeWordDetector.initialize() } returns true
        coEvery { mockWakeWordDetector.startListening() } returns Unit
        coEvery { mockSpeechToTextManager.startListening() } returns "Hello Zayd"
        ...
        wakeWordFlow.emit(WakeWordResult("zayd", 0.95f))
