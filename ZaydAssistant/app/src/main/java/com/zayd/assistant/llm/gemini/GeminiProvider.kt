package com.zayd.assistant.llm.gemini
...
class GeminiProvider(private val secureStorage: SecureStorage) : LLMProvider {
    ...
    private fun buildSystemPrompt(availableTools: List<Tool>): String {
        ...
        return """
            You are ZAYD, a helpful voice assistant. You MUST use available tools when the user requests an action that can be performed by a tool.
