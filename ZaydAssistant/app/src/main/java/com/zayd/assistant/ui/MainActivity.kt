...
import com.zayd.assistant.core.orchestrator.AssistantState
import com.zayd.assistant.databinding.ActivityMainBinding
import com.zayd.assistant.service.VoiceAssistantService
import com.zayd.assistant.ui.settings.SettingsActivity
import kotlinx.coroutines.flow.collect
import kotlinx.coroutines.launch

/**
 * Main activity for the Zayd Assistant app
    ...
    private fun testTextToSpeech() {
        lifecycleScope.launch {
            try {
                ...
                ttsManager.speak("Hello! I am Zayd, your voice assistant.")
            } catch (e: Exception) {
